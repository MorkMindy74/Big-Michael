 ...
 *
 * Ported verbatim from Mike (https://github.com/willchen96/mike, AGPL-3.0) —
 * its docxTrackedChanges engine — used unmodified except for the default
 * change author. Pure XML manipulation (jszip / fast-xml-parser / fast-diff),
 * Buffer-in / Buffer-out, with no server coupling. See NOTICE.
 *
...
export async function applyTrackedEdits(
    ...
    const author = opts?.author ?? "Big Michael";
